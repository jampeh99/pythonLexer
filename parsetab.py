...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','test.py',56),
  ('statement -> expression','statement',1,'p_statement_expr','test.py',60),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','test.py',64),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','test.py',65),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','test.py',66),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','test.py',67),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','test.py',74),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','test.py',78),
  ('expression -> NUMBER','expression',1,'p_expression_number','test.py',82),
